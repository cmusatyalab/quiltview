...
if __name__ == "__main__":
    # just for test
    pprint(post("http://typhoon.elijah.cs.cmu.edu:8000", "/api/dm/user/", {"location_lat":"11.111111", "location_long":"22.2222", "google_account":"wenlu.c.hu", "uuid":"0149B2851501001D"}))
