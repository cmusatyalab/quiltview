...
DATABASES = {
    'default': {
        ...
        'NAME': 'quiltview',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'quiltview',
        'PASSWORD': 'quiltview2013',
...
SECRET_KEY = '1)pm438d932o0$5wrxxzqwk8f0bv!4_h%j&60@z08nlf)(ki5^'
...
ROOT_URLCONF = 'quiltview.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'quiltview.wsgi.application'
